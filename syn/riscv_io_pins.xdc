...
set_property PACKAGE_PIN G6 [get_ports {rgb_led[1]}]
set_property PACKAGE_PIN F6 [get_ports {rgb_led[0]}]
...
set_output_delay -clock [get_clocks clk_out1_clk_wiz_0] -min -add_delay -2.0 [get_ports {rgb_led[*]}]
set_output_delay -clock [get_clocks clk_out1_clk_wiz_0] -max -add_delay -2.000 [get_ports {rgb_led[*]}]
set_output_delay -clock [get_clocks clk_out1_clk_wiz_0] -min -add_delay -2.000 [get_ports tx]
set_output_delay -clock [get_clocks clk_out1_clk_wiz_0] -max -add_delay -2.000 [get_ports tx]
